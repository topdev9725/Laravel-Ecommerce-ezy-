...
class VendorController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.vendor.edit',compact('data', 'categories', 'autodebit_categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($data['nearby']) && $data['nearby'] == 'on') 
            $data['nearby'] = 1;
        else
            $data['nearby'] = 0;
        ...
        if(isset($data['autodebit']) && $data['autodebit'] == 'on') {
            $data['autodebit'] = 1;
            $data['online'] = 0;
            $data['nearby'] = 0;
        }else{
        ...
        public function withdrawdatatables()
        {
             ...
             return Datatables::of($datas)
                                ...
                                ->editColumn('amount', function(Withdraw $data) {
                                    $amount = Common::formatPrice($data->amount);
                                    return $amount;
                                }) 

...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Autodebit Categories') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-autodebit-cat-index') }}">{{ __('Autodebit Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-autodebit-cat-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
						{ data: 'slug', name: 'slug' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-autodebit-cat-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+

                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Store Type') }} *</h4>
                                <p class="sub-heading">{{ __('In English') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <select name="store_type" class="input-field" required="">
                              <option value="0" {{$data->store_type == 0?'selected':''}}>{{ __('Online') }}</option>
                              <option value="1" {{$data->store_type == 1?'selected':''}}>{{ __('Nearby') }}</option>
                            </select>
                          </div>
                        </div>

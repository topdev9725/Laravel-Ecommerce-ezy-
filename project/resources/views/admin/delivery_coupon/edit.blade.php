...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Delivery Coupon') }} <a class="add-btn" href="{{route('admin-vr-delivery-coupons')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-vr-delivery_coupon-edit', $delivery_coupon->id) }}">{{ __('Edit Delivery Coupon') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-vr-delivery_coupon-update')}}" method="POST">
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
						  	<select id="vendor" name="vendor_id">
								...
								@php
								$selected = '';
								if($delivery_coupon->vendor_id == $vendor->id){
									$selected = 'selected';
								}
								@endphp
                                <option value="{{$vendor->id}}" {{$selected}}>{{ $vendor->owner_name.' ('.$vendor->shop_name.')' }}</option>                                
								@endforeach
                              </select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" id="class_name" name="class_name" placeholder="{{ __('Enter Class Name') }}" required="" value="{{$delivery_coupon->class_name}}">
                          </div>
                        </div>

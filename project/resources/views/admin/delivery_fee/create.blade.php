...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Add New Delivery Fee') }} <a class="add-btn" href="{{route('admin-vr-delivery-fees')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-vr-delivery_fee-create') }}">{{ __('Add New Delivery Fee') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>

...
@endsection
@section('content')  
					<input type="hidden" id="headerdata" value="{{ __('Surepay Deposit') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Surepay Deposit Requests') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-deposit-surepay') }}">{{ __('Surepay Request') }}</a>
											</li>
										</ul>
								</div>
							</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5 class="modal-title">{{ __('Surepay Deposit Request') }}</h5>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-deposit-surepay-datatables') }}',
               columns: [

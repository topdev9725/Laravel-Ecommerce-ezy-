                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                ...
                                                $category_id = App\Models\Product::where('id', '=', $product['item']['id'])->first()->category_id;
                                                $store_type = App\Models\Category::where('id', '=', $category_id)->first()->store_type;
                                                @endphp
                                                @if(isset($user))
                                                <a target="_blank"
                                                    href="{{ route('front.product1', $product['item']['slug']).'?store_type='.$store_type }}">{{ $product['item']['name']}}</a>
                                                @else
                                            ...
                                            <td>{{App\Classes\Common::formatPrice($product['price']) }}
                                            </td>
                                            @php
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>{{App\Classes\Common::formatPrice($subtotal) }}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{App\Classes\Common::formatPrice($order->wallet_price) }}
                                            </td>
                                        </tr>
                                            ...
                                            <tr>
                                                <td colspan="1"></td>
                                                <td>{{$order->method}}</td>
                                                <td>{{App\Classes\Common::formatPrice($order->pay_amount) }}
                                                </td>
                                            </tr>
                                            @endif
                                        @endif
                                        ...
                                        <tr>
                                            <td colspan="1"></td>
                                            <td>{{ __('Total') }}</td>
                                            <td>{{App\Classes\Common::formatPrice($order->pay_amount + $order->wallet_price) }}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>

										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-user-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" id="autocomplete" name="address" placeholder="{{ __("Address") }}" required="" value="{{ $data->address }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<select class="input-field" name="country" required id="country">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="state" id="administrative_area_level_1" placeholder="{{ __("State") }}" required="" value="{{ $data->state }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="city" id="locality" placeholder="{{ __("City") }}" value="{{ $data->city }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="zip" id="postal_code" placeholder="{{ __("Postal Code") }}" value="{{ $data->zip }}">
													</div>
												</div>
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <button class="addProductSubmit-btn" type="submit" id="btnSave">{{ __("Save") }}</button>
						                          </div>
						                        </div>

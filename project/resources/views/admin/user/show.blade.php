...
@section('content')
                                            ...
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ App\Models\Product::vendorConvertPrice($data->affilate_income) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Wallet Balance") }}</th>
                                                                <td>{{ App\Models\Product::vendorConvertPrice($data->balance) }}</td>
                                                            </tr>
                                                        </table>
                                                        </div>
                                                    </div>
            ...
            <td><a href="{{ route('admin-order-invoice',$order->id) }}">{{sprintf("%'.08d", $order->id)}}</a></td>
                                                                            ...
                                                                            <td>{{ App\Classes\Common::formatPrice($order->pay_amount) }}</td>
                                                                            <td>{{ $order->status }}</td>
                                                                            <td>

...
@endsection
@section('content')  
					<input type="hidden" id="headerdata" value="{{ __('Nearby Store Withdrawal Request') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Nearby Store Withdrawal Request') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-withdrawal-nearby') }}">{{ __('Nearby Store Withdrawal Request') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-withdrawal-nearby-datatables') }}',
               columns: [

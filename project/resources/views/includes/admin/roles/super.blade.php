<li>
    ...
    <li>
        <a href="{{ route('affiliate-users-index') }}"><i class="fas fa-users"></i>{{ __('Affiliate Users') }}</a>
    </li>
    ...
    <li>
        <a href="#delivery" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-truck"></i>{{ __('Vendor Delivery Settings') }}
        </a>
        <ul class="collapse list-unstyled" id="delivery" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-vr-delivery-fees') }}"><span>{{ $langg->lang913 }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-vr-delivery-coupons') }}"><span>{{ $langg->lang914 }}</span></a>
            </li>
        </ul>
    </li>
    <li>
        <a href="#withdraw_menu" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-dollar-sign"></i>{{ __('Withdrawal Requests') }}
        </a>
        <ul class="collapse list-unstyled" id="withdraw_menu" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-withdrawal-online') }}"><span>{{ __('Online Store') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-withdrawal-nearby') }}"><span>{{ __('Nearby Store') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-withdrawal-autodebit') }}"><span>{{ __('Autodebit') }}</span></a>
            </li>
        </ul>
    </li>
    <li>
        ...
        @endif" id="menu5" data-parent="#accordion" >
                ...
                <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='childcategory') active @endif">
                    <a href="{{ route('admin-autodebit-cat-index') }}"><span>{{ __('Autodebit Category') }}</span></a>
                </li>
        </ul>
    </li>
    ...
    <li>
        <a href="#deposit_menu" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-dollar-sign"></i>{{ __('Deposit Requests') }}
        </a>
        <ul class="collapse list-unstyled" id="deposit_menu" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-deposit-bank') }}"><span>{{ __('Bank Deposit') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-deposit-stripe') }}"><span>{{ __('Stripe Deposit') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-deposit-surepay') }}"><span>{{ __('Surepay Deposit') }}</span></a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-gs-affilate') }}"><span>{{__('Affiliate Market Plan')}}</span></a>
            </li>
            ...
            <li>
                <a href="{{ route('admin-gs-api_keys') }}"><span>{{ __('API Keys') }}</span></a>
            </li>
        </ul>
    </li>

      ...
      <div class="col-lg-6">
        <nav class="comment-log-reg-tabmenu">
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link login active" id="nav-log-tab1" data-toggle="tab" href="#" role="tab"
              aria-controls="nav-log" aria-selected="true">
              {{ $langg->lang197 }}
            </a>
            <a class="nav-item nav-link" id="nav-reg-tab1" data-toggle="tab" href="#" role="tab"
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade show" id="nav-reg1" role="tabpanel" aria-labelledby="nav-reg-tab">
...
<script>
      $('#nav-log-tab1').on( "click", function() {
        ...
        $('#nav-log1').css('display', 'block');
        $('#nav-reg1').css('display', 'none');
      });

      $('#nav-reg-tab1').on( "click", function() {
        // $('#vendor-login .modal-dialog').addClass('modal-lg');
        $('#nav-reg1').css('display', 'block');
        $('#nav-log1').css('display', 'none');
      });
</script>
@endsection
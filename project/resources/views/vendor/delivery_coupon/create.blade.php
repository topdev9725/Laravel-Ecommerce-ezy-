...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Add New Delivery Coupon') }} <a class="add-btn" href="{{route('vendor-delivery-coupons')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('vendor-delivery_coupon-create') }}">{{ __('Add New Delivery Coupon') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                          ...
                          <div class="col-lg-7">
                            <select name="deliveryfee_id" class="input-field" required="">
                              @foreach($delivery_fees as $delivery_fee)
                                <option value="{{$delivery_fee->id}}">{{ $delivery_fee->class_name }}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
